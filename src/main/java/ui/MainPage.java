...
public class MainPage extends JFrame {
	...
	private void $$$setupUI$$$() {
		...
		Font sid_fieldFont = this.$$$getFont$$$(null, -1, 24, sid_field.getFont());
		if (sid_fieldFont != null) sid_field.setFont(sid_fieldFont);
		...
		sizeLb = new JLabel();
		Font sizeLbFont = this.$$$getFont$$$(null, -1, 24, sizeLb.getFont());
		if (sizeLbFont != null) sizeLb.setFont(sizeLbFont);
		sizeLb.setText("(0): ");
